...
export const metadata: Metadata = {
  ...
  description: 'Roll Anime to Fight! Wiki terms of service.',
}
    ...
    <main className="min-h-screen px-4 pt-28 pb-16">
      <div className="container mx-auto max-w-3xl">
        ...
        <div className="space-y-5 text-muted-foreground leading-7">
          <p>By using Roll Anime to Fight! Wiki, you agree to use the site as an informational fan guide resource for Roll Anime to Fight!.</p>
